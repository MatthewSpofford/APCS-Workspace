...
/**
 * Used to store and create the base information for vehicles, along with storing the number of vehicles created
...
public abstract class Vehicles implements Comparable<Vehicles>{
	...
	private static int vehiclesMade = 0;	//Stores number of vehicle objects created
