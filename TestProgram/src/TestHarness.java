...
public class TestHarness
{
	...
	{
		SwerveMath tempCalc = new SwerveMath(19, 27.5);
//		tempCalc.Calculate(0.0, 0.0, 0.0);
	...
	public static void mathTester(SwerveMath input, double fls_max, double fls_min, double fla_max, double fla_min,
	...
	public static void compareToExpected(double input, double min, double max, String tag)
	{
		boolean value = !(max <= input && min >= input);

		if(value)
			System.out.print("ERROR: " + tag + " - " + input + " not between "
			+ min + " and " + max + "\n");
	}
}
